...
function PaymentSection(){
    return(
 <div className="w-full h-[800px] z-10  border-solid  border-red-100 font-Nunito flex justify-center items-center flex-col  gap-[50px] bg-gradient-payment md:flex-row-reverse ">
           ...
           <div className="flex gap-5 flex-col mt-10 translate-x-[-10px] translate-y-5 md:translate-y-[-20px]  md:mt-0 md:justify-center md:items-center md:w-[50%]">
                <h1 className=" text-[40px] md:w-[30vw] md:text-[72px] leading-[110%] font-semibold ">no premium<br/><span className=" text-green-C600">no payment</span></h1>
