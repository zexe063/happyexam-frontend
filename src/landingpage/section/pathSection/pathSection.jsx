...
function PathSection(){
   ...
   if(!user.id){
    ...
    return(
        <div className=" w-full h-[600px]  bg-blue-950 ">
            ...
            <div className=" w-full h-full flex flex-col   items-center justify-center gap-[50px]">
                ...
                <button className=" w-[200px] h-[50px]  flex justify-center items-center text-white font-semibold  text-4 rounded-full bg-green-500 shadow-btn-green" onClick={getStartHandle}>Get Started</button>
