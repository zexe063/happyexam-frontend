...
function HomeHeader(){
  ...
  <div className="   w-[80px] h-[35px] md:w-[100px] md:h-[45px] rounded-full bg-button_green text-white flex justify-center items-center font-semibold font-Nunito " >Get Start</div>
  </div>
