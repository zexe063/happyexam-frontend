...
function HomeHeader(){
    return(
        <div className=" w-full fixed z-50 h-[80px]  border-[1px] border-solid border-x-border_grey shadow-sm flex items-center justify-between bg-white
        ">

       <div className= " ml-3 md:ml-[100px] flex justify-center items-center gap-2 font-bold text-[20px] md:text-[32px] font-Nunito">{HappyexamLogo}HappyExam</div>
