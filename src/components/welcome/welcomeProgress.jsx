...
function WelcomeProgess({currentLength, totalLength, correctRow, handlePrevious}){
    ...
    return(
           <div className={` sticky top-0 w-full h-[50px]   flex justify-center  items-center gap-2`}>
                ...
                <div className="   relative w-[80%]  md:w-[calc(100%-40%)] rounded-full h-[8px] bg-gray-A50 flex gap-2 justify-center items-center">
